...
public class CallQueueManager<E> {
    private static final Logger LOG = Logger.getLogger(CallQueueManager.class);
    ...
    public CallQueueManager(Class<? extends BlockingQueue<E>> backingClass,
                            int maxQueueSize, String namespace) {
        BlockingQueue<E> bq = createCallQueueInstance(backingClass,
                maxQueueSize, namespace);
